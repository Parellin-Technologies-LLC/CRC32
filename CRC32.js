...
class CRC32
{
    constructor( buffer, opts = {} )
    {
        ...
        this.encoding  = opts.encoding || CRC32.HEX;

        if( !buffer ) {
            throw new Error( 'Argument Error - `buffer` is a required parameter' );
        ...
        this.value = this.calc_crc( buffer );
        return this.value;
    }
    ...
    calc_crc( buffer )
    {
        ...
        return blocks.map(
            buf => {
                ...
                return this.encoding === CRC32.INT ? crc : crc.toString( this.encoding );
            }
        );
    }
    ...
    get_block( buffer, size, index )
    {
        ...
        return buffer.slice( chunk, chunk + size );
    }
